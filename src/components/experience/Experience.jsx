...
// toggle
  const descriptionContent = document.getElementsByClassName('journey__description'),
  ...
  function activeExpand () {
    ...
    for (let i = 0; i < descriptionContent.length; i++) {
      descriptionContent[i].className = 'journey__description description__close'
    } 
              ...
              return (
                ...
                <div className="journey__data">
                  ...
                  <div className="journey__text-box">
                    ...
                    <h4 className="journey__company">{item.company}
                    <span className="journey__date">{item.date}</span>
                    </h4> 
                    <div className='education__description'>{item.description}</div>
                  </div>
                </div>
                </>
              )
