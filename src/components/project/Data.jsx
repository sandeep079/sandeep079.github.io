...
export const Data = [
    ...
    },
    {
        ...
        description: 'A game in which you help Hackee, the squirrel, in her walnut heist while visualizing different sorting algorithms and a maze generator created using recursive depth first search. There are two levels.',
    ...
    },
    {
        ...
        demo: '',
        description: 'A chess game with features such as timer, single/multi-player mode, scoreboard, and resign options, created using C++ and SDL2 for GUI.',
        stack: ['C++', 'SDL2', 'CMAKE'],
    },
    {
        image: clhp,
        ...
        demo: '',
        description: 'Here is the list of projects and assignments I did during the fellowship.',
    ...
    },
    {
        ...
        description:  (
            <ul>
                <li>Sathi is a friendly app for Type I Diabetic Patients to make their life easier. It sends notification to the patient regarding timely blood sugar checkup and medication, to the trusted person if the patient misses the notification, and  to the doctor if the patient's blood sugar level goes extremely high.</li><br />
                <li> Project Details: 
